...
const char* ssid     = "youtSSID";
const char* password = "yourPassword";

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "yourAPIKEY";                      // See: https://openweathermap.org/
...
String City             = "Seville";                      // Your home city See: http://bulk.openweathermap.org/sample/
